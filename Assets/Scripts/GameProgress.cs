...
public class GameProgress : MonoBehaviour
{
    ...
    [SerializeField] private Transform endingPanel; // ← 이름 변경
    [SerializeField] private TextMeshProUGUI endingText; // ← 추가
    ...
    void GameComplete()
    {
        ...
        StartCoroutine(FadeOutAndShowEnding(true)); // ← true = 성공
    }
    ...
    void GameOver()
    {
        ...
        StartCoroutine(FadeOutAndShowEnding(false)); // ← false = 실패
    }
